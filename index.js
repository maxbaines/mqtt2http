...
const MQTT_CONNECT = process.env.MQTT_CONNECT
  ? JSON.parse(process.env.MQTT_CONNECT)
  : {};
const MQTT_TOPIC = IS_JSON.test(process.env.MQTT_TOPIC)
  ? JSON.parse(process.env.MQTT_TOPIC)
  : process.env.MQTT_TOPIC;
const MQTT_SUBSCRIBE = process.env.MQTT_SUBSCRIBE
  ? JSON.parse(process.env.MQTT_SUBSCRIBE)
  : undefined;
...
let client = MQTT_URL
  ? mqtt.connect(MQTT_URL, MQTT_CONNECT)
